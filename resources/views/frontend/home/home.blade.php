        ...
        <div class="container">
            <div class="hero-content-home">
                <div class="badge-home">
                    ...
                    <span class="badge-text-home">Ingeniería Térmica Avanzada</span>
                </div>
    ...
    <section class="why-section-home">
        <div class="container why-grid-home">
            <div class="content-left-home">
                <p class="section-subtitle-home">Por Qué Elegirnos</p>
            ...
            <div class="cta-box-home">
                ...
                <div class="cta-content-home">
                    ...
                    <div class="cta-buttons-home">
                        <button class="button-primary home-white">
                            Solicitar Asesoría
                        </button>

                        <button class="button-primary home-dark">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path
