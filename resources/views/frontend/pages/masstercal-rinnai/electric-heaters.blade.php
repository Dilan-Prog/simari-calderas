    ...
    <div class="re-hero__grid">
      ...
      <div>
        ...
        <p class="re-hero__desc">
          Agua caliente instantánea sin gas. Tecnología eléctrica de alta eficiencia para máxima seguridad y comodidad en tu hogar.
        </p>
    ...
    <div class="re-pricing__grid">
      ...
      <article class="re-price-card" aria-labelledby="plan-basico">
        ...
        <ul class="re-price-card__list" aria-label="Características del plan Básico">
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Ideal para 1-2 personas</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Termostato ajustable</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Protección anti-quemaduras</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Garantía 3 años</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Instalación incluida</li>
        </ul>
        <a href="/contacto" class="re-price-card__btn re-price-card__btn--dark" rel="noopener">Solicitar Básico</a>
      </article>
      ...
      <article class="re-price-card re-price-card--featured" aria-labelledby="plan-premium">
        ...
        <ul class="re-price-card__list" aria-label="Características del plan Premium">
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Perfecto para 3-4 personas</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Control digital LCD</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Doble termostato</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Ánodo de magnesio</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Garantía 5 años</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Mantenimiento gratis 1 año</li>
        </ul>
        <a href="/contacto" class="re-price-card__btn re-price-card__btn--light" rel="noopener">Solicitar Premium</a>
      </article>
      ...
      <article class="re-price-card" aria-labelledby="plan-elite">
        ...
        <ul class="re-price-card__list" aria-label="Características del plan Elite">
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Para familias grandes 5-6 personas</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Wi-Fi + App móvil</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Autodiagnóstico inteligente</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Aislamiento premium</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Garantía 7 años</li>
          <li><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>Servicio prioritario</li>
        </ul>
        <a href="/contacto" class="re-price-card__btn re-price-card__btn--dark" rel="noopener">Solicitar Elite</a>
      </article>
...
<section class="re-sustain" id="sustentabilidad" aria-labelledby="re-sustain-title">
  <div class="re-sustain__inner">
    ...
    <div class="re-sustain__header">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/></svg>
    ...
    <div class="re-sustain__grid">
      ...
      <article class="re-sustain-card" aria-labelledby="sc-emisiones">
        <div class="re-sustain-card__body">
          <div class="re-sustain-card__icon" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/></svg>
          </div>
          <div class="re-sustain-card__text">
            ...
            <p class="re-sustain-card__desc">Al ser 100% eléctrico, no genera gases contaminantes ni requiere ventilación especial. Perfecto para espacios cerrados.</p>
          </div>
        </div>
      </article>
      ...
      <article class="re-sustain-card" aria-labelledby="sc-eficiencia">
        <div class="re-sustain-card__body">
          <div class="re-sustain-card__icon" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
          </div>
          <div class="re-sustain-card__text">
            <div class="re-sustain-card__top">
            ...
            <p class="re-sustain-card__desc">Convierte el 98% de la energía en calor útil, superando a sistemas tradicionales de gas o combustible.</p>
          </div>
        </div>
      </article>
      ...
      <article class="re-sustain-card" aria-labelledby="sc-solar">
        <div class="re-sustain-card__body">
          <div class="re-sustain-card__icon" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/></svg>
          </div>
          <div class="re-sustain-card__text">
            <div class="re-sustain-card__top">
            ...
            <p class="re-sustain-card__desc">Compatible con paneles solares. Instala tu sistema fotovoltaico y obtén agua caliente con energía 100% limpia.</p>
          </div>
        </div>
      </article>
      ...
      <article class="re-sustain-card" aria-labelledby="sc-cert">
        <div class="re-sustain-card__body">
          <div class="re-sustain-card__icon" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526"/><circle cx="12" cy="8" r="6"/></svg>
          </div>
          <div class="re-sustain-card__text">
            <div class="re-sustain-card__top">
            ...
            <p class="re-sustain-card__desc">Cumple con las normas internacionales más estrictas de eficiencia energética y cuidado ambiental.</p>
          </div>
        </div>
      </article>
