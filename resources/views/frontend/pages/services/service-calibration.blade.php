...
@section('content')
            ...
            <div class="service-calibration-table-aplication">
                ...
                <ul class="applications__list">
                    <li class="applications__item">
                        ...
                        <p class="applications__item-des">Quemadores industriales</p>
                    </li>
                    <li class="applications__item"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <p class="applications__item-des">Manómetros y transmisores</p>
                    </li>
                    <li class="applications__item"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-circle-check-big">
                        ...
                        <p class="applications__item-des">Sensores de temperatura</p>
                    </li>
                    <li class="applications__item"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-circle-check-big">
                        ...
                        <p class="applications__item-des">Válvulas de seguridad</p>
                    </li>
                    <li class="applications__item"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-circle-check-big">
                        ...
                        <p class="applications__item-des">Controles de nivel</p>
                    </li>
                    <li class="applications__item"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-circle-check-big">
                        ...
                        <p class="applications__item-des">Analizadores de gases</p>
                    </li>
                </ul>
            </div>
    </section>
    ...
    {{-- THIRD SECTION --}}
    <section class="service-calibration-accordion">
    ...
    {{-- SUB SECTION --}}
    <section class="first-content-service-calibration sub">
        <div class="container text-service-calibration sub">
            <h2 class="service-calibration-title-sub">Optimice su Eficiencia Energética</h2>
            <p class="service-calibration-des-sub">Quemadores descalibrados generan desperdicios permanentes. Implemente calibración certificada profesional.
            </p>
            {{-- Buttons declaration --}}
