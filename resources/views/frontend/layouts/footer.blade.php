...
====================================================== -->
<a href="https://wa.me/524494348018"
   ...
   aria-label="Contáctanos por WhatsApp">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.553 4.124 1.523 5.86L.057 23.428a.75.75 0 0 0 .916.916l5.568-1.466A11.942 11.942 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.907 0-3.693-.513-5.228-1.407l-.374-.22-3.876 1.021 1.021-3.754-.234-.386A9.956 9.956 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
    </svg>
</a>
