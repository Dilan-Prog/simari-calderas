@push('scripts')
    ...
    <script>
        (function() {
            ...
            const WIDTHS_STORAGE_KEY = 'admin_products_bulk_edit_column_widths';
            const PINNED_COLS = ['_select', 'name', 'sku'];
            const MIN_COL_WIDTH = 50;
            const MAX_COL_WIDTH = 800;
            const DEFAULT_COL_WIDTHS = {
                _select: 40, name: 180, sku: 130, supplier_sku: 160, suppliers: 200,
                model: 160, short_description: 200, description: 200,
                price: 120, price_includes_tax: 120, compare_price: 120, cost: 120, shipping_cost: 120, free_shipping_threshold: 140,
                ...
                tags: 160, specifications: 160,
                seo_title: 160, seo_description: 200, seo_keywords: 160,
                og_title: 160, og_description: 200, og_image: 160, canonical_url: 160, faqs: 160,
            };
