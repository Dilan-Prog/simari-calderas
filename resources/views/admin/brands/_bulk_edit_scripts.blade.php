@push('scripts')
    <script>
        (function() {
            ...
            const filterControls = [searchInput, statusFilter, perPageSelect];

            [statusFilter, perPageSelect].forEach(select => {
            ...
            const saveUrl = '{{ route('admin.brands.bulk.save') }}';
            ...
            const COLUMNS_STORAGE_KEY = 'admin_brands_bulk_edit_visible_columns';
            ...
            function loadStoredColumns() {
                ...
                try {
                    ...
                    // localStorage corrupto: se ignora y se mantienen los
                    // defaults renderizados por el servidor.
                }
            }
            ...
            const bulkEditViewsUrl = '{{ url('/admin/marcas/edicion-masiva/vistas') }}';
