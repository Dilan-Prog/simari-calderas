        ...
        <div class="qwiz-step-panel" data-qwiz-step="2">
            <div class="quotes-card">
                ...
                {{-- Moneda del documento + tipo de cambio USD→MXN editable
                     por cotización. El valor por defecto viene del tipo de
                     cambio global vigente (Products::exchangeRate()), pero
                     es un campo editable de verdad — se guarda tal cual lo
                     deje el usuario al momento de guardar. --}}
                <div class="form-group">
                ...
                {{-- FIX: solo aplica cuando el cliente seleccionado es
                     persona moral (retiene ISR a quien le presta el
                     servicio, per LISR Art. 106). Deshabilitado por
                     defecto — clientSelect JS lo habilita/limpia según
                     data-tipo-persona del cliente elegido. --}}
                <div class="form-group">
                    ...
                    <input type="number" name="isr_retention_rate" id="isrRetentionRate" class="form-input {{ $errors->has('isr_retention_rate') ? 'is-invalid' : '' }}"
                           value="{{ old('isr_retention_rate', 10) }}" step="0.01" min="0" max="100" disabled>
                    ...
                    <div class="quotes-card">
                        ...
                        <div class="summary-totals">
                            ...
                            <div class="summary-totals__row" id="displayRetentionRow" style="display:none">
                                <span>Retención ISR (<span id="displayRetentionRate">0</span>%)</span>
...
(function () {
    ...
    // FIX: sesión expirada durante la búsqueda — antes fetchProducts()
    // se tragaba el 401 y esto caía en showResults([]), mostrando
    // "Sin resultados" (falso). Ahora se distingue explícitamente.
