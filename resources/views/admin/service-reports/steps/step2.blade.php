...
<div class="sr-create-wrap">
    ...
    <div class="sr-form-card">
        ...
        <form method="POST" action="{{ route('service-reports.save-step', [$report, 2]) }}" id="step2Form">
            @csrf
            ...
            <div class="sr-form-footer">
                <a href="{{ route('service-reports.step', [$report, 1]) }}" class="sr-btn-outline">← Anterior</a>
