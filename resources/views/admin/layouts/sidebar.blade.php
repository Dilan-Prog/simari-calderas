...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav" id="sidebarNav">
        ...
        @if ($authUser->hasPermission('categories'))
            <a class="sidebar-nav-item {{ $activeSection === 'categories' ? 'active' : '' }}" data-section="categories" data-label="Categorías"
        ...
        @if ($authUser->hasPermission('brands'))
            <a class="sidebar-nav-item {{ $activeSection === 'brands' ? 'active' : '' }}" data-section="brands" data-label="Marcas"
