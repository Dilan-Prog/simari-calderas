        ...
        (function() {
            ...
            function renderItems() {
                ...
                <td>
                    ...
                    <input type="hidden" name="items[${index}][line_total]"       value="0"            class="h-line">
                    <input type="hidden" name="items[${index}][sort_order]"       value="${index}">
                </td>
                <td>
                    <input type="text" class="po-item-input ${item.fromCatalog ? 'po-item-input--readonly' : ''}"
                ...
                <td>
                    <span id="po-line-${item.id}" class="po-item-total">${fmt(item.lineTotal ?? 0)}</span>
                </td>
                <td>
            ...
            // Before submit
            document.getElementById('poCreateForm').addEventListener('submit', function() {
            ...
            document.getElementById('poCreateForm').addEventListener('submit', function(e) {
                ...
                if (items.length === 0) {
                    ...
                    const existing = toolbar.nextElementSibling?.querySelector('.po-error-msg');
                    if (!existing) {
                        const span = document.createElement('span');
                        span.className = 'po-error-msg';
