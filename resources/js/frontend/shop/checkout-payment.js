...
function init() {
    ...
    function openCheckoutProPopup(url, thanksUrl) {
        ...
        // completó, para que pueda reintentar de inmediato. Antes se navegaba
        // a thanksUrl "por si acaso" incluso en este caso, lo que mostraba
        // "¡Pedido confirmado!" sin que se hubiera cobrado nada.
