...
class UserManageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('emergency_contact_name') || $request->filled('emergency_phone') || $request->filled('relationship')) {
            ...
            $contactEmergency->phone        = $request->emergency_phone;
            $contactEmergency->relationship = $request->relationship;
    ...
    public function update(Request $request, string $id)
    {
        ...
        $contact = $user->contactEmergency()->first();
        if ($request->filled('emergency_contact_name') || $request->filled('emergency_phone') || $request->filled('relationship')) {
            if ($contact) {
                $contact->name         = $request->emergency_contact_name;
                $contact->phone        = $request->emergency_phone;
