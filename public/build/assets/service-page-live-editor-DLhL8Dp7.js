import{S as de}from"./sortable.esm-D-EvzYhP.js";(function(){const b=window.__LIVE_EDITOR__;if(!b)return;const k=document.querySelector('meta[name="csrf-token"]').content,I={banner:"Banner",dual_banner:"Banner Doble",product_carousel:"Carrusel de Productos",product_carousel_banner:"Carrusel con Banner",category_grid:"Grid de Categorías",brand_carousel:"Carrusel de Marcas",html_block:"Bloque HTML",faq:"Preguntas Frecuentes",rich_header:"Encabezado enriquecido",content_tabs:"Descripción por secciones",benefits_grid:"Beneficios / características",process_steps:"Proceso / cómo funciona",gallery_carousel:"Galería / carrusel",rating_reviews:"Rating y reseñas",cta_final:"CTA final",button:"Botón",table_block:"Tabla"},G={banner:'<rect width="18" height="12" x="3" y="6" rx="2"/><path d="M3 10h18"/>',dual_banner:'<rect width="8" height="14" x="3" y="5" rx="1.5"/><rect width="8" height="14" x="13" y="5" rx="1.5"/>',product_carousel:'<circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/>',product_carousel_banner:'<rect width="18" height="12" x="3" y="6" rx="2"/><circle cx="9" cy="12" r="2"/>',category_grid:'<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/>',brand_carousel:'<path d="M12 2 2 7l10 5 10-5-10-5Z"/><path d="m2 17 10 5 10-5"/><path d="m2 12 10 5 10-5"/>',html_block:'<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>',faq:'<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" x2="12.01" y1="17" y2="17"/>',rich_header:'<rect width="20" height="14" x="2" y="3" rx="2"/><line x1="2" x2="22" y1="9" y2="9"/>',content_tabs:'<path d="M21 15V6"/><path d="M18.5 18a2.5 2.5 0 1 0 0-5H8a2 2 0 1 0 0 4h10"/><path d="M3 3v18"/><path d="M14 6H3"/>',benefits_grid:'<rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/>',process_steps:'<path d="M4 17V9a2 2 0 0 1 2-2h2"/><path d="m18 8 4 4-4 4"/><path d="M4 21v-2a2 2 0 0 1 2-2h2"/><path d="M14 3h6v6"/>',gallery_carousel:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',rating_reviews:'<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',cta_final:'<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>',button:'<rect width="18" height="7" x="3" y="8.5" rx="3.5"/>',table_block:'<path d="M3 3h18v18H3z"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/>',default:'<rect width="18" height="18" x="3" y="3" rx="2"/>'},ue={featured:"Destacados",new:"Nuevos",recommended:"Recomendados",category:"Por Categoría",brand:"Por Marca",collection:"Por Colección",manual:"Selección Manual"};function Te(t){switch(t){case"banner":return{image_url:"",link_url:"",alt:""};case"dual_banner":return{left:{image_url:"",link_url:"",alt:""},right:{image_url:"",link_url:"",alt:""}};case"product_carousel":return{source:"featured",category_id:null,brand_id:null,collection_id:null,product_ids:[],limit:10};case"product_carousel_banner":return{banner_image_url:"",banner_link_url:"",banner_alt:"",source:"featured",category_id:null,brand_id:null,collection_id:null,product_ids:[],limit:10};case"category_grid":return{category_ids:[]};case"brand_carousel":return{};case"html_block":return{html:""};case"faq":return{description:""};case"rich_header":return{badges:[],whatsapp_text:"Cotizar por WhatsApp",meta_lines:[],background_image_ids:[],price_label:""};case"content_tabs":return{tabs:[]};case"benefits_grid":return{items:[],layout:"horizontal"};case"process_steps":return{steps:[]};case"gallery_carousel":return{image_ids:[]};case"rating_reviews":return{description:"",reviews_per_page:3};case"cta_final":return{headline:"",subtext:"",whatsapp_text:"Cotizar por WhatsApp",background_image_id:null,secondary_button:{text:"",url:"",style:"outline",color:"#ff6213"}};case"button":return{buttons:[{text:"Cotizar ahora",url:"",style:"solid",color:"#ff6213"}],align:"center"};case"table_block":return{title:"",description:"",headers:[],rows:[],buttons:[],align:"left"};default:return{}}}let W=0;const pe=()=>"u"+ ++W,E=(b.sections||[]).map(t=>({_uid:pe(),id:t.id??null,type:t.type,title:t.title??"",config:t.config&&typeof t.config=="object"?t.config:{},is_active:t.is_active!==!1}));let C=null,L="empty",ve=!1,V="desktop";const p=Object.assign({name:"",slug:"",sort_order:0,short_description:"",price:"",currency:"MXN",show_price:!0,background_color:null,seo_title:"",seo_description:"",canonical_url:"",is_active:!1,faqs:[],rating_average_displayed:"",rating_total_rated:"",rating_recommend_percent:"",rating_punctuality_average:"",rating_recurring_clients:"",rating_since_year:"",rating_distribution:{}},b.general||{}),S=(b.reviews||[]).map(t=>Object.assign({},t)),P=document.getElementById("leBlocksList"),Re=document.getElementById("leAddBlockType"),Be=document.getElementById("leAddBlockBtn"),w=document.getElementById("leEditPanel"),H=document.getElementById("leIframe"),j=document.getElementById("leDirtyIndicator"),A=document.getElementById("leSaveBtn"),ge=document.getElementById("leViewportToggle"),K=document.getElementById("leGeneralInfoBtn"),J=document.getElementById("leGalleryBtn"),X=document.getElementById("leReviewsBtn"),me=document.querySelector(".live-editor-heading-row__left h1"),F=document.getElementById("leDeleteModal"),Ae=document.getElementById("leDeleteModalTitle"),Me=document.getElementById("leDeleteModalAvatar"),Ie=document.getElementById("leDeleteModalCancel"),Ge=document.getElementById("leDeleteModalConfirm");let Q=null;function Y(t,e){Q=e,Ae.textContent=t,Me.textContent=(t||"?").charAt(0).toUpperCase(),F.classList.add("active")}function Z(){Q=null,F.classList.remove("active")}Ie.addEventListener("click",Z),F.addEventListener("click",t=>{t.target===F&&Z()}),Ge.addEventListener("click",()=>{const t=Q;Z(),typeof t=="function"&&t()});function s(t){return String(t??"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Pe(t){return String(t??"").toLowerCase().normalize("NFD").replace(/[^\x00-\x7F]/g,"").replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-")}const He=["#000000","#141516","#374151","#4b5563","#6b7280","#9ca3af","#d1d5db","#f3f4f6","#ffffff","#ef4444","#f97316","#ff6213","#f59e0b","#eab308","#84cc16","#22c55e","#10b981","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#7c2d12","#78350f","#365314","#134e4a","#1e3a8a","#4c1d95"],ye="emb-custom-colors";function je(){try{const t=window.localStorage.getItem(ye),e=t?JSON.parse(t):[];return Array.isArray(e)?e:[]}catch{return[]}}function he(t){try{window.localStorage.setItem(ye,JSON.stringify(t))}catch{}}function be(t){return/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.test(t)}function ee(t,e,a){let r=je();function n(i,v){return`<button type="button" class="le-color-swatch ${e&&e.toLowerCase()===i.toLowerCase()?"is-active":""}" data-hex="${i}" title="${i}" style="background:${i}">
                ...
                <div class="le-color-custom-row">
                    <input type="color" class="le-color-native" value="${be(e)?e:"#ff6213"}">
            ...
            `,t.querySelectorAll(".le-color-swatch").forEach(o=>{o.addEventListener("click",h=>{h.target.closest(".le-color-swatch-remove")||(a(o.dataset.hex),l())})}),t.querySelectorAll(".le-color-swatch-remove").forEach(o=>{o.addEventListener("click",h=>{h.stopPropagation();const y=o.dataset.remove;r=r.filter(m=>m!==y),he(r),l()})});const i=t.querySelector(".le-color-native"),v=t.querySelector(".le-color-hex");i.addEventListener("input",()=>{v.value=i.value}),t.querySelector(".le-color-save").addEventListener("click",()=>{let o=v.value.trim();o&&(o.startsWith("#")||(o="#"+o),be(o)&&(r.includes(o)||(r=[...r,o],he(r)),a(o),l()))})}l()}function M(t,e,a){a=a||{};const r=a.tagChoices||null,n=a.onChange||(()=>{}),l="leStyle"+ ++W;function i(){c(),n(),d()}const v=r?u("Etiqueta de encabezado",`
        ...
        `,t.querySelector("#leTbDesc").addEventListener("input",i=>{e.description=i.target.value,c(),d()});const r=t.querySelector("#leTbHeaders");e.headers.forEach((i,v)=>{const o=document.createElement("div");o.className="hs-repeat-row",o.innerHTML=`
            ...
            `).join("");o.innerHTML=`
                ...
                ${h}
            `,o.querySelectorAll(".le-cell").forEach(y=>{y.addEventListener("input",m=>{i[parseInt(m.target.dataset.ci,10)]=m.target.value,c(),d()})}),o.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.rows.splice(v,1),c(),T(t,e),d()}),n.appendChild(o)}),t.querySelector("#leTbAddRow").addEventListener("click",()=>{e.rows.push(new Array(a).fill("")),c(),T(t,e),d()});const l=t.querySelector("#leTbButtons");e.buttons.forEach((i,v)=>{const o=document.createElement("div");o.className="hs-repeat-row";const h=document.createElement("div");h.className="hs-repeat-row-head",h.innerHTML=`<span class="hs-repeat-row-num">${v+1}</span><button type="button" class="hs-faq-btn hs-repeat-remove" title="Eliminar">&times;</button>`,o.appendChild(h);const y=document.createElement("div");o.appendChild(y),te(y,i,{alignField:!1}),h.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.buttons.splice(v,1),c(),T(t,e),d()}),l.appendChild(o)}),t.querySelector("#leTbAddBtn").addEventListener("click",()=>{e.buttons.push({text:"",url:"",style:"outline",color:"#ff6213"}),c(),T(t,e),d()})}function c(){ve||(ve=!0,j.textContent="● Cambios sin guardar",j.className="live-editor-status is-dirty")}function we(t){return E.find(e=>e._uid===t)||null}let _e=null;function $(){if(P.innerHTML="",!E.length){const t=document.createElement("div");t.className="live-editor-blocks-empty",t.textContent="Este servicio todavía no tiene bloques. Agrega uno abajo.",P.appendChild(t);return}E.forEach(t=>{const e=document.createElement("div");e.className="live-editor-block-row",L==="block"&&t._uid===C&&e.classList.add("is-selected"),t.is_active||e.classList.add("is-inactive"),e.dataset.uid=t._uid;const a=G[t.type]||G.default;e.innerHTML=`
            ...
            `,e.addEventListener("click",r=>{r.target.closest(".live-editor-toggle-active")||r.target.closest(".live-editor-block-delete")||re(t._uid)}),e.querySelector(".live-editor-toggle-active").addEventListener("click",r=>{r.stopPropagation(),t.is_active=!t.is_active,c(),$(),d()}),e.querySelector(".live-editor-block-delete").addEventListener("click",r=>{r.stopPropagation();const n=t.title||I[t.type]||t.type;Y(n,()=>{const l=E.findIndex(i=>i._uid===t._uid);l!==-1&&E.splice(l,1),C===t._uid&&(C=null,R()),c(),$(),d()})}),P.appendChild(e)}),_e||(_e=new de(P,{animation:150,handle:".live-editor-block-drag-handle",forceFallback:!0,ghostClass:"live-editor-block-row--ghost",dragClass:"live-editor-block-row--dragging",onEnd(t){if(t.oldIndex===t.newIndex)return;const[e]=E.splice(t.oldIndex,1);E.splice(t.newIndex,0,e),c(),$(),d()}}))}function D(){K.classList.remove("is-selected"),J.classList.remove("is-selected"),X.classList.remove("is-selected")}function re(t){C=t,L="block",D(),$(),R()}function fe(){C=null,L="general",D(),K.classList.add("is-selected"),$(),R()}function Fe(){C=null,L="gallery",D(),J.classList.add("is-selected"),$(),R()}function De(){C=null,L="reviews",D(),X.classList.add("is-selected"),$(),R()}K.addEventListener("click",fe),J.addEventListener("click",Fe),X.addEventListener("click",De),Be.addEventListener("click",()=>{const t=Re.value,e={_uid:pe(),id:null,type:t,title:"",config:Te(t),is_active:!0};E.push(e),c(),re(e._uid),d()});function u(t,e,a){return`<div class="live-editor-field ${a||""}">
            <label>${s(t)}</label>
            ${e}
            ...
            ${u("Orden",`<input type="number" min="0" step="1" class="users-manager-input" id="leGenSortOrder" value="${s(p.sort_order)}">`,"")}
        ...
        `,w.querySelector("#leGenSaveBtn").addEventListener("click",()=>O()),w.querySelector("#leGenSlugGenerate").addEventListener("click",()=>{const i=w.querySelector("#leGenName");w.querySelector("#leGenSlug").value=Pe(i.value),c()});const t=w.querySelector("#leGenIsCanonical"),e=w.querySelector("#leGenCanonicalUrlWrap");t.addEventListener("change",()=>{e.style.display=t.checked?"none":""});const a=w.querySelector("#leGenPageType"),r=w.querySelector(".leGenParentField"),n=()=>{const i=a.value==="hub"||a.value==="category";r&&(r.style.display=i?"none":"")};a.addEventListener("change",n),n();const l=w.querySelector("#leGenBgColorClear");ee(w.querySelector("#leGenBgColorPicker"),p.background_color||"",i=>{p.background_color=i,l.disabled=!1,c()}),l.addEventListener("click",()=>{p.background_color=null,l.disabled=!0,xe(),c()})}function ie(t){p.faqs=p.faqs||[];const e=t;e&&(e.innerHTML="",p.faqs.forEach((a,r)=>{const n=document.createElement("div");n.className="hs-faq-row",n.innerHTML=`
        ...
        `,z()}function z(){const t=w.querySelector("#leGalleryGrid");if(!t)return;t.innerHTML="",(b.images||[]).forEach((a,r)=>{const n=document.createElement("div");n.className="service-gallery-item",n.dataset.id=a.id,n.innerHTML=`
            ...
            `,n.querySelector(".service-gallery-item__remove").addEventListener("click",()=>{Y(a.alt_text||"Imagen #"+a.id,()=>ze(a.id))});let l=null;n.querySelector(".service-gallery-item__alt").addEventListener("input",i=>{a.alt_text=i.target.value,clearTimeout(l),l=setTimeout(()=>Ue(a.id,a.alt_text),500)}),t.appendChild(n)});const e=document.createElement("div");e.className="service-gallery-item service-gallery-item--add",e.id="leGalleryAddTile",e.innerHTML=`
        ...
        `,e.addEventListener("click",()=>{typeof window.openImagePicker=="function"&&window.openImagePicker(null,{onSelect:Oe})}),t.appendChild(e),new de(t,{animation:150,handle:".service-gallery-item__drag",filter:".service-gallery-item--add",forceFallback:!0,ghostClass:"service-gallery-item--ghost",dragClass:"service-gallery-item--dragging",onEnd(a){if(a.oldIndex===a.newIndex)return;const[r]=b.images.splice(a.oldIndex,1);b.images.splice(a.newIndex,0,r),z(),We()}})}async function Oe(t){try{const e=await fetch(b.imagesStoreUrl,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":k,Accept:"application/json"},body:JSON.stringify({image_url:t,alt_text:""})}),a=await e.json();e.ok?(b.images.push({id:a.image.id,url:a.image.url,alt_text:a.image.alt_text}),z(),window.showCenterToast&&showCenterToast("Imagen agregada."),d()):window.showCenterToast&&showCenterToast("No se pudo agregar la imagen.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al agregar la imagen.","error")}}async function ze(t){try{if((await fetch(b.imageDestroyUrlTemplate.replace("__IMAGE_ID__",t),{method:"DELETE",headers:{"X-CSRF-TOKEN":k,Accept:"application/json"}})).ok){const a=b.images.findIndex(r=>String(r.id)===String(t));a!==-1&&b.images.splice(a,1),z(),window.showCenterToast&&showCenterToast("Imagen eliminada."),d()}else window.showCenterToast&&showCenterToast("No se pudo eliminar la imagen.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al eliminar la imagen.","error")}}async function Ue(t,e){try{await fetch(b.imageUpdateUrlTemplate.replace("__IMAGE_ID__",t),{method:"PUT",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":k,Accept:"application/json"},body:JSON.stringify({alt_text:e})})}catch{}}async function We(){const t=b.images.map(e=>e.id);try{(await fetch(b.imagesReorderUrl,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":k,Accept:"application/json"},body:JSON.stringify({order:t})})).ok?(window.showCenterToast&&showCenterToast("Orden de galería actualizado."),d()):window.showCenterToast&&showCenterToast("No se pudo guardar el nuevo orden de la galería.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al reordenar la galería.","error")}}function ne(){const t=S.filter(e=>e.is_visible).length;w.innerHTML=`
            <div class="live-editor-panel-header">
                <span class="live-editor-panel-header-info">
                    <span class="live-editor-block-icon">
        ...
        `,Se(),w.querySelector("#leReviewAddBtn").addEventListener("click",()=>$e(null))}function Se(){const t=w.querySelector("#leReviewsList");if(t){if(t.innerHTML="",!S.length){t.innerHTML='<p class="hs-config-note">Todavía no hay reseñas capturadas para este servicio.</p>';return}S.forEach(e=>{const a=document.createElement("div");a.className="service-review-row",a.dataset.id=e.id;const r=e.comment||"";a.innerHTML=`
            ...
            `,a.querySelector(".edit").addEventListener("click",()=>$e(e)),a.querySelector(".delete").addEventListener("click",()=>{Y(e.customer_name||"Reseña",()=>Ke(e.id))}),t.appendChild(a)}),new de(t,{animation:150,handle:".service-review-row__drag",forceFallback:!0,ghostClass:"service-review-row--ghost",dragClass:"service-review-row--dragging",onEnd(e){if(e.oldIndex===e.newIndex)return;const[a]=S.splice(e.oldIndex,1);S.splice(e.newIndex,0,a),Se(),Je()}})}}function $e(t){const e=!!t,a=w.querySelector("#leReviewFormWrap");if(!a)return;const r=e?Object.assign({},t):{customer_name:"",customer_role:"",customer_company:"",customer_city:"",customer_state:"",review_date:"",rating:5,comment:"",categories:[],is_verified:!1,is_visible:!0,business_response:"",business_response_date:""};a.innerHTML=`
        ...
        `,w.querySelector("#lePanelClose").addEventListener("click",()=>{C=null,$(),R()}),w.querySelector("#leTitle").addEventListener("input",a=>{t.title=a.target.value,c(),$(),d()}),Ee.includes(t.type)){const a=t.config=t.config||{};a.title_style=a.title_style||{},M(w.querySelector("#leTitleStyle"),a.title_style,{tagChoices:["h2","h3"]})}Xe(w.querySelector("#leTypeFields"),t)}const Ee=["benefits_grid","process_steps","content_tabs","gallery_carousel","faq"];function Xe(t,e){const a=e.config=e.config||{};switch(e.type){case"banner":U(t,a,"");break;case"dual_banner":t.innerHTML='<p class="hs-config-subtitle">Banner Izquierdo</p><div id="leDbLeft"></div><p class="hs-config-subtitle">Banner Derecho</p><div id="leDbRight"></div>',a.left=a.left||{image_url:"",link_url:"",alt:""},a.right=a.right||{image_url:"",link_url:"",alt:""},U(t.querySelector("#leDbLeft"),a.left,"Left"),U(t.querySelector("#leDbRight"),a.right,"Right");break;case"product_carousel":ke(t,a,"");break;case"product_carousel_banner":t.innerHTML='<p class="hs-config-subtitle">Banner</p><div id="lePcbBanner"></div><p class="hs-config-subtitle">Productos del carrusel</p><div id="lePcbCarousel"></div>',U(t.querySelector("#lePcbBanner"),{image_url:a.banner_image_url,link_url:a.banner_link_url,alt:a.banner_alt},"PcbBanner",(r,n)=>{r==="image_url"&&(a.banner_image_url=n),r==="link_url"&&(a.banner_link_url=n),r==="alt"&&(a.banner_alt=n)}),ke(t.querySelector("#lePcbCarousel"),a,"Pcb");break;case"category_grid":Ye(t,a);break;case"brand_carousel":t.innerHTML='<p class="hs-config-note">Este bloque muestra automáticamente todas las marcas activas. No requiere configuración adicional.</p>';break;case"html_block":Ze(t,a);break;case"faq":et(t,a);break;case"rich_header":tt(t,a);break;case"content_tabs":le(t,a);break;case"benefits_grid":se(t,a);break;case"process_steps":oe(t,a);break;case"gallery_carousel":at(t,a);break;case"rating_reviews":rt(t,a);break;case"cta_final":it(t,a);break;case"button":ae(t,a);break;case"table_block":T(t,a);break;default:t.innerHTML='<p class="hs-config-note">Tipo de bloque desconocido.</p>'}}function U(t,e,a,r){const n="leBanner"+a+"Image",l="leBanner"+a+"Link",i="leBanner"+a+"Alt";t.innerHTML=`
            ${u("URL de Imagen",`
        ...
        `;const v=g=>r?r("image_url",g):e.image_url=g,o=g=>r?r("link_url",g):e.link_url=g,h=g=>r?r("alt",g):e.alt=g,y=t.querySelector("#"+n);y.addEventListener("input",()=>{v(y.value),c(),d()}),t.querySelector("#"+l).addEventListener("input",g=>{o(g.target.value),c(),d()}),t.querySelector("#"+i).addEventListener("input",g=>{h(g.target.value),c(),d()}),t.querySelector(".img-picker-trigger-btn").addEventListener("click",()=>{typeof window.openImagePicker=="function"&&window.openImagePicker(n)})}function ke(t,e,a){const r="leSource"+a,n="leLimit"+a,l="leCategory"+a,i="leBrand"+a,v="leCollection"+a,o="leManualWrap"+a,h=Object.keys(ue).map(m=>`<option value="${m}" ${e.source===m?"selected":""}>${ue[m]}</option>`).join("");t.innerHTML=`
            <div class="live-editor-field-row">
        ...
        `;const r=t.querySelector(".hs-product-search__input"),n=t.querySelector(".hs-product-search__dropdown"),l=t.querySelector(".hs-product-search__list"),i=t.querySelector(".hs-product-search__empty"),v=t.querySelector(".hs-product-chips");let o=[],h=null;function y(){v.innerHTML="",o.forEach(_=>{const f=document.createElement("span");f.className="hs-product-chip",f.innerHTML=`<span>${s(_.name)}</span><small>${s(_.sku)}</small><button type="button" aria-label="Quitar">&times;</button>`,f.querySelector("button").addEventListener("click",()=>{o=o.filter(x=>x.id!==_.id),y(),a(o.map(x=>x.id))}),v.appendChild(f)})}function m(){n.style.display="none",l.innerHTML=""}function g(_){l.innerHTML="";const f=_.filter(x=>!o.some(q=>q.id===x.id));if(!f.length){i.style.display="block",l.style.display="none";return}i.style.display="none",l.style.display="block",f.forEach(x=>{const q=document.createElement("li");q.className="hs-product-search__item",q.innerHTML=`<span>${s(x.name)}</span><small>SKU: ${s(x.sku)}</small>`,q.addEventListener("click",()=>{o.push({id:x.id,name:x.name,sku:x.sku}),y(),a(o.map(ce=>ce.id)),r.value="",m()}),l.appendChild(q)})}async function B(_){try{const f=new URL(b.productsSearchUrl,window.location.origin);Object.entries(_).forEach(([q,ce])=>f.searchParams.set(q,ce));const x=await fetch(f.toString(),{headers:{Accept:"application/json"}});return x.ok?await x.json():[]}catch{return[]}}r.addEventListener("input",function(){const _=this.value.trim();if(clearTimeout(h),_.length<2){m();return}h=setTimeout(async()=>{const f=await B({q:_});n.style.display="block",g(f)},300)}),document.addEventListener("click",_=>{t.contains(_.target)||m()}),e&&e.length&&B({ids:e.join(",")}).then(_=>{o=_.map(f=>({id:f.id,name:f.name,sku:f.sku})),y()})}function Ye(t,e){t.innerHTML=u("Categorías a mostrar (vacío = todas las principales activas)",`
        ...
        `,t.querySelector("#leFaqDescription").addEventListener("input",a=>{e.description=a.target.value,c(),d()}),t.querySelector("#leFaqAdd").addEventListener("click",()=>{p.faqs=p.faqs||[],p.faqs.push({question:"",answer:""}),c(),ie(t.querySelector("#leFaqRows"))}),ie(t.querySelector("#leFaqRows")),t.querySelector("#leFaqSaveBtn").addEventListener("click",()=>O({btnId:"leFaqSaveBtn",errorsBoxId:"leFaqErrors"}))}function tt(t,e){t.innerHTML=`
...
`).map(o=>o.trim()).filter(Boolean),c(),d()}),i.querySelector(".le-image").addEventListener("change",v=>{n.image_id=v.target.value||null,c(),d()}),i.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.tabs.splice(l,1),c(),le(t,e),d()}),n.style=n.style||{},M(i.querySelector(".le-tab-style"),n.style,{}),r.appendChild(i)}),t.querySelector("#leCtAdd").addEventListener("click",()=>{e.tabs.push({label:"",subtitle:"",body:"",bullets:[],image_id:null}),c(),le(t,e),d()})}function se(t,e){e.items=e.items||[],e.layout=e.layout==="vertical"?"vertical":"horizontal",t.innerHTML=`
        ...
        `,t.querySelector("#leBgLayout").addEventListener("change",r=>{e.layout=r.target.value,c(),d()});const a=t.querySelector("#leBgRows");e.items.forEach((r,n)=>{const l=document.createElement("div");l.className="hs-repeat-row",l.innerHTML=`
            ...
            `,l.querySelector(".le-title").addEventListener("input",i=>{r.title=i.target.value,c(),$(),d()}),l.querySelector(".le-description").addEventListener("input",i=>{r.description=i.target.value,c(),d()}),l.querySelector(".le-duration").addEventListener("input",i=>{r.duration=i.target.value,c(),d()}),l.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.steps.splice(n,1),c(),oe(t,e),d()}),a.appendChild(l)}),t.querySelector("#lePsAdd").addEventListener("click",()=>{e.steps.push({title:"",description:"",duration:""}),c(),oe(t,e),d()})}function at(t,e){t.innerHTML=u("Imágenes a mostrar (vacío = toda la galería)",`
        ...
        `,t.querySelector("#leCtaHeadline").addEventListener("input",a=>{e.headline=a.target.value,c(),d()}),t.querySelector("#leCtaSubtext").addEventListener("input",a=>{e.subtext=a.target.value,c(),d()}),t.querySelector("#leCtaWhatsapp").addEventListener("input",a=>{e.whatsapp_text=a.target.value,c(),d()}),t.querySelector("#leCtaBg").addEventListener("change",a=>{e.background_image_id=a.target.value||null,c(),d()}),e.headline_style=e.headline_style||{},e.subtext_style=e.subtext_style||{},M(t.querySelector("#leCtaHeadlineStyle"),e.headline_style,{tagChoices:["h2","h3"]}),M(t.querySelector("#leCtaSubtextStyle"),e.subtext_style,{}),e.secondary_button=e.secondary_button||{text:"",url:"",style:"outline",color:"#ff6213"},te(t.querySelector("#leCtaSecondaryBtn"),e.secondary_button,{alignField:!1})}let Ce=null;function d(){clearTimeout(Ce),Ce=setTimeout(Le,400)}async function Le(){try{const e=await(await fetch(b.previewUrl,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":k,Accept:"application/json"},body:JSON.stringify({sections:E.filter(a=>a.is_active).map((a,r)=>({...a,sort_order:r}))})})).json();H.srcdoc=e.html??""}catch(t){console.error("Error generando el preview:",t)}}H.addEventListener("load",()=>{try{const t=H.contentDocument;if(!t)return;const e=we(C);if(e&&e.id){const a=t.createElement("style");a.textContent=`[data-section-id="${e.id}"] { outline: 3px solid #ff6213; outline-offset: 2px; cursor: pointer; }`,t.head.appendChild(a)}t.body.addEventListener("click",a=>{const r=a.target.closest("[data-section-id]");if(!r)return;const n=r.getAttribute("data-section-id"),l=E.find(i=>String(i.id)===String(n));l&&(a.preventDefault(),re(l._uid))},!0)}catch{}});const qe=document.getElementById("leViewportCaption");function nt(){qe&&(qe.textContent=V==="mobile"?"Móvil · 375px":"Escritorio · 1440px")}ge.addEventListener("click",t=>{const e=t.target.closest("button[data-viewport]");e&&(V=e.dataset.viewport,ge.querySelectorAll("button").forEach(a=>a.classList.toggle("is-active",a===e)),H.classList.toggle("is-mobile",V==="mobile"),nt())}),A.addEventListener("click",async()=>{A.disabled=!0;const t=A.textContent;A.textContent="Guardando...",j.textContent="Guardando…",j.className="live-editor-status is-saving",w.querySelector("#leGenSaveBtn")?await O():w.querySelector("#leFaqSaveBtn")&&await O({btnId:"leFaqSaveBtn",errorsBoxId:"leFaqErrors"});try{if(!(await fetch(b.saveUrl,{method:"PUT",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":k,Accept:"application/json"},body:JSON.stringify({sections:E.map((a,r)=>({...a,sort_order:r}))})})).ok)throw new Error("save request failed");window.location.reload()}catch(e){console.error("Error guardando la página:",e),alert("No se pudieron guardar los cambios. Intenta de nuevo."),A.disabled=!1,A.textContent=t,c()}}),E.length?($(),R()):fe(),Le()})();
