(function(){const b=window.__LIVE_EDITOR__;if(!b)return;const $=document.querySelector('meta[name="csrf-token"]').content,j={banner:"Banner",dual_banner:"Banner Doble",product_carousel:"Carrusel de Productos",product_carousel_banner:"Carrusel con Banner",category_grid:"Grid de Categorías",brand_carousel:"Carrusel de Marcas",html_block:"Bloque HTML",faq:"Preguntas Frecuentes",rich_header:"Encabezado enriquecido",content_tabs:"Descripción por secciones",benefits_grid:"Beneficios / características",process_steps:"Proceso / cómo funciona",gallery_carousel:"Galería / carrusel",rating_reviews:"Rating y reseñas",cta_final:"CTA final",button:"Botón",table_block:"Tabla"},D={banner:'<rect width="18" height="12" x="3" y="6" rx="2"/><path d="M3 10h18"/>',dual_banner:'<rect width="8" height="14" x="3" y="5" rx="1.5"/><rect width="8" height="14" x="13" y="5" rx="1.5"/>',product_carousel:'<circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/>',product_carousel_banner:'<rect width="18" height="12" x="3" y="6" rx="2"/><circle cx="9" cy="12" r="2"/>',category_grid:'<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/>',brand_carousel:'<path d="M12 2 2 7l10 5 10-5-10-5Z"/><path d="m2 17 10 5 10-5"/><path d="m2 12 10 5 10-5"/>',html_block:'<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>',faq:'<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" x2="12.01" y1="17" y2="17"/>',rich_header:'<rect width="20" height="14" x="2" y="3" rx="2"/><line x1="2" x2="22" y1="9" y2="9"/>',content_tabs:'<path d="M21 15V6"/><path d="M18.5 18a2.5 2.5 0 1 0 0-5H8a2 2 0 1 0 0 4h10"/><path d="M3 3v18"/><path d="M14 6H3"/>',benefits_grid:'<rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/>',process_steps:'<path d="M4 17V9a2 2 0 0 1 2-2h2"/><path d="m18 8 4 4-4 4"/><path d="M4 21v-2a2 2 0 0 1 2-2h2"/><path d="M14 3h6v6"/>',gallery_carousel:'<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',rating_reviews:'<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',cta_final:'<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>',button:'<rect width="18" height="7" x="3" y="8.5" rx="3.5"/>',table_block:'<path d="M3 3h18v18H3z"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/>',default:'<rect width="18" height="18" x="3" y="3" rx="2"/>'},pe={featured:"Destacados",new:"Nuevos",recommended:"Recomendados",category:"Por Categoría",brand:"Por Marca",collection:"Por Colección",manual:"Selección Manual"};function Re(t){switch(t){case"banner":return{image_url:"",link_url:"",alt:""};case"dual_banner":return{left:{image_url:"",link_url:"",alt:""},right:{image_url:"",link_url:"",alt:""}};case"product_carousel":return{source:"featured",category_id:null,brand_id:null,collection_id:null,product_ids:[],limit:10};case"product_carousel_banner":return{banner_image_url:"",banner_link_url:"",banner_alt:"",source:"featured",category_id:null,brand_id:null,collection_id:null,product_ids:[],limit:10};case"category_grid":return{category_ids:[]};case"brand_carousel":return{};case"html_block":return{html:""};case"faq":return{description:""};case"rich_header":return{badges:[],whatsapp_text:"Cotizar por WhatsApp",meta_lines:[],background_image_ids:[],price_label:""};case"content_tabs":return{tabs:[]};case"benefits_grid":return{items:[],layout:"horizontal"};case"process_steps":return{steps:[]};case"gallery_carousel":return{image_ids:[]};case"rating_reviews":return{description:"",reviews_per_page:3};case"cta_final":return{headline:"",subtext:"",whatsapp_text:"Cotizar por WhatsApp",background_image_id:null,secondary_button:{text:"",url:"",style:"outline",color:"#ff6213"}};case"button":return{buttons:[{text:"Cotizar ahora",url:"",style:"solid",color:"#ff6213"}],align:"center"};case"table_block":return{title:"",description:"",headers:[],rows:[],buttons:[],align:"left"};default:return{}}}let K=0;const ve=()=>"u"+ ++K,S=(b.sections||[]).map(t=>({_uid:ve(),id:t.id??null,type:t.type,title:t.title??"",config:t.config&&typeof t.config=="object"?t.config:{},is_active:t.is_active!==!1}));let k=null,C="empty",ge=!1,J="desktop";const v=Object.assign({name:"",slug:"",short_description:"",price:"",currency:"MXN",show_price:!0,background_color:null,seo_title:"",seo_description:"",canonical_url:"",is_active:!1,faqs:[],rating_average_displayed:"",rating_total_rated:"",rating_recommend_percent:"",rating_punctuality_average:"",rating_recurring_clients:"",rating_since_year:"",rating_distribution:{}},b.general||{}),x=(b.reviews||[]).map(t=>Object.assign({},t)),H=document.getElementById("leBlocksList"),Ae=document.getElementById("leAddBlockType"),Me=document.getElementById("leAddBlockBtn"),_=document.getElementById("leEditPanel"),F=document.getElementById("leIframe"),N=document.getElementById("leDirtyIndicator"),G=document.getElementById("leSaveBtn"),me=document.getElementById("leViewportToggle"),X=document.getElementById("leGeneralInfoBtn"),Q=document.getElementById("leGalleryBtn"),Y=document.getElementById("leReviewsBtn"),ye=document.querySelector(".live-editor-heading-row__left h1"),O=document.getElementById("leDeleteModal"),Be=document.getElementById("leDeleteModalTitle"),Ie=document.getElementById("leDeleteModalAvatar"),Ge=document.getElementById("leDeleteModalCancel"),Pe=document.getElementById("leDeleteModalConfirm");let Z=null;function ee(t,e){Z=e,Be.textContent=t,Ie.textContent=(t||"?").charAt(0).toUpperCase(),O.classList.add("active")}function te(){Z=null,O.classList.remove("active")}Ge.addEventListener("click",te),O.addEventListener("click",t=>{t.target===O&&te()}),Pe.addEventListener("click",()=>{const t=Z;te(),typeof t=="function"&&t()});function o(t){return String(t??"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function He(t){return String(t??"").toLowerCase().normalize("NFD").replace(/[^\x00-\x7F]/g,"").replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-")}const je=["#000000","#141516","#374151","#4b5563","#6b7280","#9ca3af","#d1d5db","#f3f4f6","#ffffff","#ef4444","#f97316","#ff6213","#f59e0b","#eab308","#84cc16","#22c55e","#10b981","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#7c2d12","#78350f","#365314","#134e4a","#1e3a8a","#4c1d95"],he="emb-custom-colors";function De(){try{const t=window.localStorage.getItem(he),e=t?JSON.parse(t):[];return Array.isArray(e)?e:[]}catch{return[]}}function be(t){try{window.localStorage.setItem(he,JSON.stringify(t))}catch{}}function _e(t){return/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.test(t)}function re(t,e,r){let a=De();function i(n,p){return`<button type="button" class="le-color-swatch ${e&&e.toLowerCase()===n.toLowerCase()?"is-active":""}" data-hex="${n}" title="${n}" style="background:${n}">
                ...
                ${a.length?`
                    ...
                    <div class="le-color-swatches">${a.map(s=>i(s,!0)).join("")}</div>
                `:""}
            ...
            `,t.querySelectorAll(".le-color-swatch").forEach(s=>{s.addEventListener("click",h=>{h.target.closest(".le-color-swatch-remove")||(r(s.dataset.hex),l())})}),t.querySelectorAll(".le-color-swatch-remove").forEach(s=>{s.addEventListener("click",h=>{h.stopPropagation();const m=s.dataset.remove;a=a.filter(y=>y!==m),be(a),l()})});const n=t.querySelector(".le-color-native"),p=t.querySelector(".le-color-hex");n.addEventListener("input",()=>{p.value=n.value}),t.querySelector(".le-color-save").addEventListener("click",()=>{let s=p.value.trim();s&&(s.startsWith("#")||(s="#"+s),_e(s)&&(a.includes(s)||(a=[...a,s],be(a)),r(s),l()))})}l()}function P(t,e,r){r=r||{};const a=r.tagChoices||null,i=r.onChange||(()=>{}),l="leStyle"+ ++K;function n(){c(),i(),d()}const p=a?u("Etiqueta de encabezado",`
            <select class="users-manager-select" id="${l}Tag">
                ${a.map(s=>`<option value="${s}" ${(e.heading_tag||a[0])===s?"selected":""}>${s.toUpperCase()}</option>`).join("")}
            </select>
        `):"";t.innerHTML=`
        ...
        `,t.querySelector("#leBtnAlign").addEventListener("change",a=>{e.align=a.target.value,c(),d()});const r=t.querySelector("#leBtnRows");e.buttons.forEach((a,i)=>{const l=document.createElement("div");l.className="hs-repeat-row";const n=document.createElement("div");n.className="hs-repeat-row-head",n.innerHTML=`<span class="hs-repeat-row-num">${i+1}</span><button type="button" class="hs-faq-btn hs-repeat-remove" title="Eliminar">&times;</button>`,l.appendChild(n);const p=document.createElement("div");l.appendChild(p),ae(p,a,{alignField:!1}),n.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.buttons.splice(i,1),c(),ie(t,e),d()}),r.appendChild(l)}),t.querySelector("#leBtnAdd").addEventListener("click",()=>{e.buttons.push({text:"",url:"",style:"outline",color:"#ff6213"}),c(),ie(t,e),d()})}function T(t,e){e.headers=Array.isArray(e.headers)?e.headers:[],e.rows=Array.isArray(e.rows)?e.rows:[],e.buttons=Array.isArray(e.buttons)?e.buttons:[],e.align=e.align||"left";const r=Math.max(e.headers.length,1);t.innerHTML=`
        ...
        `,t.querySelector("#leTbDesc").addEventListener("input",n=>{e.description=n.target.value,c(),d()});const a=t.querySelector("#leTbHeaders");e.headers.forEach((n,p)=>{const s=document.createElement("div");s.className="hs-repeat-row",s.innerHTML=`
            ...
            `,s.querySelector(".le-header").addEventListener("input",h=>{e.headers[p]=h.target.value,c(),d()}),s.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.headers.splice(p,1),e.rows.forEach(h=>h.splice(p,1)),c(),T(t,e),d()}),a.appendChild(s)}),t.querySelector("#leTbAddCol").addEventListener("click",()=>{e.headers.push(""),e.rows.forEach(n=>n.push("")),c(),T(t,e),d()});const i=t.querySelector("#leTbRows");e.rows.forEach((n,p)=>{for(;n.length<r;)n.push("");const s=document.createElement("div");s.className="hs-repeat-row";const h=n.map((m,y)=>`
            ...
            `).join("");s.innerHTML=`
                ...
                ${h}
            `,s.querySelectorAll(".le-cell").forEach(m=>{m.addEventListener("input",y=>{n[parseInt(y.target.dataset.ci,10)]=y.target.value,c(),d()})}),s.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.rows.splice(p,1),c(),T(t,e),d()}),i.appendChild(s)}),t.querySelector("#leTbAddRow").addEventListener("click",()=>{e.rows.push(new Array(r).fill("")),c(),T(t,e),d()});const l=t.querySelector("#leTbButtons");e.buttons.forEach((n,p)=>{const s=document.createElement("div");s.className="hs-repeat-row";const h=document.createElement("div");h.className="hs-repeat-row-head",h.innerHTML=`<span class="hs-repeat-row-num">${p+1}</span><button type="button" class="hs-faq-btn hs-repeat-remove" title="Eliminar">&times;</button>`,s.appendChild(h);const m=document.createElement("div");s.appendChild(m),ae(m,n,{alignField:!1}),h.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.buttons.splice(p,1),c(),T(t,e),d()}),l.appendChild(s)}),t.querySelector("#leTbAddBtn").addEventListener("click",()=>{e.buttons.push({text:"",url:"",style:"outline",color:"#ff6213"}),c(),T(t,e),d()})}function c(){ge||(ge=!0,N.textContent="● Cambios sin guardar",N.className="live-editor-status is-dirty")}function we(t){return S.find(e=>e._uid===t)||null}let R=null;function L(){if(H.innerHTML="",!S.length){const t=document.createElement("div");t.className="live-editor-blocks-empty",t.textContent="Este servicio todavía no tiene bloques. Agrega uno abajo.",H.appendChild(t);return}S.forEach(t=>{const e=document.createElement("div");e.className="live-editor-block-row",C==="block"&&t._uid===k&&e.classList.add("is-selected"),t.is_active||e.classList.add("is-inactive"),e.draggable=!0,e.dataset.uid=t._uid;const r=D[t.type]||D.default;e.innerHTML=`
                ...
                <span class="live-editor-block-info">
                    <span class="live-editor-block-name">${o(t.title||j[t.type]||t.type)}</span>
                    <span class="live-editor-block-type">${o(j[t.type]||t.type)}</span>
                </span>
            ...
            `,e.addEventListener("click",a=>{a.target.closest(".live-editor-toggle-active")||a.target.closest(".live-editor-block-delete")||ne(t._uid)}),e.querySelector(".live-editor-toggle-active").addEventListener("click",a=>{a.stopPropagation(),t.is_active=!t.is_active,c(),L(),d()}),e.querySelector(".live-editor-block-delete").addEventListener("click",a=>{a.stopPropagation();const i=t.title||j[t.type]||t.type;ee(i,()=>{const l=S.findIndex(n=>n._uid===t._uid);l!==-1&&S.splice(l,1),k===t._uid&&(k=null,B()),c(),L(),d()})}),e.addEventListener("dragstart",()=>{H.querySelectorAll(".live-editor-block-row").forEach(a=>{a.classList.remove("is-dragging","drag-over")}),R=t._uid,e.classList.add("is-dragging")}),e.addEventListener("dragend",()=>{R=null,H.querySelectorAll(".live-editor-block-row").forEach(a=>{a.classList.remove("is-dragging","drag-over")})}),e.addEventListener("dragover",a=>{a.preventDefault(),!(R===null||R===t._uid)&&e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>{e.classList.remove("drag-over")}),e.addEventListener("drop",a=>{if(a.preventDefault(),e.classList.remove("drag-over"),R===null||R===t._uid)return;const i=S.findIndex(p=>p._uid===R);if(i===-1)return;const[l]=S.splice(i,1),n=S.findIndex(p=>p._uid===t._uid);S.splice(n===-1?i:n,0,l),c(),L(),d()}),H.appendChild(e)})}function z(){X.classList.remove("is-selected"),Q.classList.remove("is-selected"),Y.classList.remove("is-selected")}function ne(t){k=t,C="block",z(),L(),B()}function fe(){k=null,C="general",z(),X.classList.add("is-selected"),L(),B()}function Fe(){k=null,C="gallery",z(),Q.classList.add("is-selected"),L(),B()}function Ne(){k=null,C="reviews",z(),Y.classList.add("is-selected"),L(),B()}X.addEventListener("click",fe),Q.addEventListener("click",Fe),Y.addEventListener("click",Ne),Me.addEventListener("click",()=>{const t=Ae.value,e={_uid:ve(),id:null,type:t,title:"",config:Re(t),is_active:!0};S.push(e),c(),ne(e._uid),d()});function u(t,e,r){return`<div class="live-editor-field ${r||""}">
            <label>${o(t)}</label>
            ${e}
        </div>`}function U(t,e){const r=(t||[]).map(String);return(e||[]).map(a=>`<option value="${a.id}" ${r.includes(String(a.id))?"selected":""}>${o(a.alt_text||"Imagen #"+a.id)}</option>`).join("")}function xe(){_.innerHTML=`
        ...
        `,W()}function W(){const t=_.querySelector("#leGalleryGrid");if(!t)return;t.innerHTML="",(b.images||[]).forEach((r,a)=>{const i=document.createElement("div");i.className="service-gallery-item",i.dataset.id=r.id,i.draggable=!0,i.innerHTML=`
                ...
                <img src="${r.url}" alt="${o(r.alt_text||"")}">
                <input type="text" class="users-manager-input service-gallery-item__alt" placeholder="Texto alternativo" value="${o(r.alt_text||"")}">
            `,i.querySelector(".service-gallery-item__remove").addEventListener("click",()=>{ee(r.alt_text||"Imagen #"+r.id,()=>Ue(r.id))});let l=null;i.querySelector(".service-gallery-item__alt").addEventListener("input",n=>{r.alt_text=n.target.value,clearTimeout(l),l=setTimeout(()=>We(r.id,r.alt_text),500)}),i.addEventListener("dragstart",()=>{t.querySelectorAll(".service-gallery-item").forEach(n=>{n.classList.remove("is-dragging","drag-over")}),A=r.id,i.classList.add("is-dragging")}),i.addEventListener("dragend",()=>{A=null,t.querySelectorAll(".service-gallery-item").forEach(n=>{n.classList.remove("is-dragging","drag-over")})}),i.addEventListener("dragover",n=>{n.preventDefault(),!(A===null||A===r.id)&&i.classList.add("drag-over")}),i.addEventListener("dragleave",()=>{i.classList.remove("drag-over")}),i.addEventListener("drop",n=>{if(n.preventDefault(),i.classList.remove("drag-over"),A===null||A===r.id)return;const p=b.images.findIndex(m=>String(m.id)===String(A));if(p===-1)return;const[s]=b.images.splice(p,1),h=b.images.findIndex(m=>String(m.id)===String(r.id));b.images.splice(h===-1?p:h,0,s),W(),Ve()}),t.appendChild(i)});const e=document.createElement("div");e.className="service-gallery-item service-gallery-item--add",e.id="leGalleryAddTile",e.innerHTML=`
        ...
        `,e.addEventListener("click",()=>{typeof window.openImagePicker=="function"&&window.openImagePicker(null,{onSelect:ze})}),t.appendChild(e)}async function ze(t){try{const e=await fetch(b.imagesStoreUrl,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":$,Accept:"application/json"},body:JSON.stringify({image_url:t,alt_text:""})}),r=await e.json();e.ok?(b.images.push({id:r.image.id,url:r.image.url,alt_text:r.image.alt_text}),W(),window.showCenterToast&&showCenterToast("Imagen agregada."),d()):window.showCenterToast&&showCenterToast("No se pudo agregar la imagen.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al agregar la imagen.","error")}}async function Ue(t){try{if((await fetch(b.imageDestroyUrlTemplate.replace("__IMAGE_ID__",t),{method:"DELETE",headers:{"X-CSRF-TOKEN":$,Accept:"application/json"}})).ok){const r=b.images.findIndex(a=>String(a.id)===String(t));r!==-1&&b.images.splice(r,1),W(),window.showCenterToast&&showCenterToast("Imagen eliminada."),d()}else window.showCenterToast&&showCenterToast("No se pudo eliminar la imagen.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al eliminar la imagen.","error")}}async function We(t,e){try{await fetch(b.imageUpdateUrlTemplate.replace("__IMAGE_ID__",t),{method:"PUT",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":$,Accept:"application/json"},body:JSON.stringify({alt_text:e})})}catch{}}async function Ve(){const t=b.images.map(e=>e.id);try{(await fetch(b.imagesReorderUrl,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":$,Accept:"application/json"},body:JSON.stringify({order:t})})).ok?(window.showCenterToast&&showCenterToast("Orden de galería actualizado."),d()):window.showCenterToast&&showCenterToast("No se pudo guardar el nuevo orden de la galería.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al reordenar la galería.","error")}}let M=null;function se(){const t=x.filter(e=>e.is_visible).length;_.innerHTML=`
            <div class="live-editor-panel-header">
                <span class="live-editor-panel-header-info">
                    <span class="live-editor-block-icon">
        ...
        `,Ee(),_.querySelector("#leReviewAddBtn").addEventListener("click",()=>Le(null))}function Ee(){const t=_.querySelector("#leReviewsList");if(t){if(t.innerHTML="",!x.length){t.innerHTML='<p class="hs-config-note">Todavía no hay reseñas capturadas para este servicio.</p>';return}x.forEach(e=>{const r=document.createElement("div");r.className="service-review-row",r.draggable=!0,r.dataset.id=e.id;const a=e.comment||"";r.innerHTML=`
                ...
                <div class="service-review-row__body">
                    ...
                    <p class="service-review-row__comment">${o(a.length>140?a.slice(0,140)+"…":a)}</p>
                </div>
            ...
            `,r.querySelector(".edit").addEventListener("click",()=>Le(e)),r.querySelector(".delete").addEventListener("click",()=>{ee(e.customer_name||"Reseña",()=>Je(e.id))}),r.addEventListener("dragstart",()=>{t.querySelectorAll(".service-review-row").forEach(i=>{i.classList.remove("is-dragging","drag-over")}),M=e.id,r.classList.add("is-dragging")}),r.addEventListener("dragend",()=>{M=null,t.querySelectorAll(".service-review-row").forEach(i=>{i.classList.remove("is-dragging","drag-over")})}),r.addEventListener("dragover",i=>{i.preventDefault(),!(M===null||M===e.id)&&r.classList.add("drag-over")}),r.addEventListener("dragleave",()=>r.classList.remove("drag-over")),r.addEventListener("drop",i=>{if(i.preventDefault(),r.classList.remove("drag-over"),M===null||M===e.id)return;const l=x.findIndex(s=>String(s.id)===String(M));if(l===-1)return;const[n]=x.splice(l,1),p=x.findIndex(s=>String(s.id)===String(e.id));x.splice(p===-1?l:p,0,n),Ee(),Xe()}),t.appendChild(r)})}}function Le(t){const e=!!t,r=_.querySelector("#leReviewFormWrap");if(!r)return;const a=e?Object.assign({},t):{customer_name:"",customer_role:"",customer_company:"",customer_city:"",customer_state:"",review_date:"",rating:5,comment:"",categories:[],is_verified:!1,is_visible:!0,business_response:"",business_response_date:""};r.innerHTML=`
            <div class="show-user-divider" style="margin:14px 0 10px;"></div>
            <p class="live-editor-col-title">${e?"Editar reseña":"Nueva reseña"}</p>
            ${u("Cliente",`<input type="text" class="users-manager-input" id="leRevName" value="${o(a.customer_name)}">`)}
            <div class="live-editor-field-row">
                ${u("Puesto (opcional)",`<input type="text" class="users-manager-input" id="leRevRole" value="${o(a.customer_role)}" placeholder="Jefe de mantenimiento">`)}
                ${u("Empresa (opcional)",`<input type="text" class="users-manager-input" id="leRevCompany" value="${o(a.customer_company)}">`)}
            </div>
            <div class="live-editor-field-row">
                ${u("Ciudad (opcional)",`<input type="text" class="users-manager-input" id="leRevCity" value="${o(a.customer_city)}">`)}
                ${u("Estado (opcional)",`<input type="text" class="users-manager-input" id="leRevState" value="${o(a.customer_state)}" placeholder="JAL">`)}
            </div>
            ${u("Fecha",`<input type="date" class="users-manager-input" id="leRevDate" value="${o(a.review_date)}">`)}
            ${u("Calificación",`<div class="service-review-stars-input" id="leRevStars"></div><input type="hidden" id="leRevRating" value="${a.rating||5}">`)}
            <div class="live-editor-field">
                <label>Comentario &middot; <span id="leRevCommentCount">${(a.comment||"").length}</span>/240</label>
                <textarea class="users-manager-input client-modal-textarea" id="leRevComment" rows="3" maxlength="240">${o(a.comment)}</textarea>
            </div>
            ${u("Categorías",`
                <div class="hs-product-chips" style="flex-wrap:wrap;">
                    ${Object.entries(b.reviewCategories||{}).map(([n,p])=>`
                        <label style="display:inline-flex;align-items:center;gap:4px;border:1px solid #d1d5db;border-radius:999px;padding:4px 10px;font-size:12.5px;cursor:pointer;font-weight:400;">
                            <input type="checkbox" class="le-rev-category" value="${o(n)}" ${(a.categories||[]).includes(n)?"checked":""}> ${o(p)}
                        </label>
                    `).join("")}
                </div>
            `)}
            <div class="live-editor-field-row">
                ${u("",`<label style="display:flex;align-items:center;gap:8px;font-weight:400;font-size:13px;color:#374151;"><input type="checkbox" id="leRevVerified" ${a.is_verified?"checked":""}> Cliente verificado</label>`)}
                ${u("",`<label style="display:flex;align-items:center;gap:8px;font-weight:400;font-size:13px;color:#374151;"><input type="checkbox" id="leRevVisible" ${a.is_visible?"checked":""}> Visible en público</label>`)}
            </div>
            ${u("Respuesta de Equiterm (opcional)",`<textarea class="users-manager-input client-modal-textarea" id="leRevResponse" rows="2">${o(a.business_response)}</textarea>`)}
            ${u("Fecha de respuesta (opcional)",`<input type="date" class="users-manager-input" id="leRevResponseDate" value="${o(a.business_response_date)}">`)}
        ...
        `;const i=r.querySelector("#leRevStars");function l(n){r.querySelector("#leRevRating").value=n,i.innerHTML="";for(let p=1;p<=5;p++){const s=document.createElement("button");s.type="button",s.className="service-review-star"+(p<=n?" is-active":""),s.textContent="★",s.addEventListener("click",()=>l(p)),i.appendChild(s)}}l(a.rating||5),r.querySelector("#leRevComment").addEventListener("input",function(){r.querySelector("#leRevCommentCount").textContent=this.value.length}),r.querySelector("#leRevCancel").addEventListener("click",()=>{r.innerHTML=""}),r.querySelector("#leRevSave").addEventListener("click",()=>Ke(e?t.id:null,r)),r.scrollIntoView({behavior:"smooth",block:"nearest"})}async function Ke(t,e){const r=e.querySelector("#leRevErrors");r.style.display="none",r.innerHTML="";const a={customer_name:e.querySelector("#leRevName").value,customer_role:e.querySelector("#leRevRole").value||null,customer_company:e.querySelector("#leRevCompany").value||null,customer_city:e.querySelector("#leRevCity").value||null,customer_state:e.querySelector("#leRevState").value||null,review_date:e.querySelector("#leRevDate").value||null,rating:parseInt(e.querySelector("#leRevRating").value,10)||5,comment:e.querySelector("#leRevComment").value,categories:Array.from(e.querySelectorAll(".le-rev-category:checked")).map(n=>n.value),is_verified:e.querySelector("#leRevVerified").checked,is_visible:e.querySelector("#leRevVisible").checked,business_response:e.querySelector("#leRevResponse").value||null,business_response_date:e.querySelector("#leRevResponseDate").value||null},i=e.querySelector("#leRevSave");i.disabled=!0;const l=i.textContent;i.textContent="Guardando...";try{const n=t?b.reviewUpdateUrlTemplate.replace("__REVIEW_ID__",t):b.reviewsStoreUrl,p=await fetch(n,{method:t?"PUT":"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":$,Accept:"application/json"},body:JSON.stringify(a)}),s=await p.json();if(p.ok){if(t){const h=x.findIndex(m=>String(m.id)===String(t));h!==-1&&(x[h]=Object.assign({},x[h],s.review))}else x.push(s.review);se(),window.showCenterToast&&showCenterToast(t?"Reseña actualizada.":"Reseña creada."),d()}else if(p.status===422){const h=s.errors||{};r.innerHTML=Object.values(h).flat().map(m=>`<p>${m}</p>`).join(""),r.style.display="block",i.disabled=!1,i.textContent=l}else throw new Error("save-review-failed")}catch{r.innerHTML="<p>No se pudo guardar. Intenta de nuevo.</p>",r.style.display="block",i.disabled=!1,i.textContent=l}}async function Je(t){try{if((await fetch(b.reviewDestroyUrlTemplate.replace("__REVIEW_ID__",t),{method:"DELETE",headers:{"X-CSRF-TOKEN":$,Accept:"application/json"}})).ok){const r=x.findIndex(a=>String(a.id)===String(t));r!==-1&&x.splice(r,1),se(),window.showCenterToast&&showCenterToast("Reseña eliminada."),d()}else window.showCenterToast&&showCenterToast("No se pudo eliminar la reseña.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al eliminar la reseña.","error")}}async function Xe(){const t=x.map(e=>e.id);try{(await fetch(b.reviewsReorderUrl,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":$,Accept:"application/json"},body:JSON.stringify({order:t})})).ok?window.showCenterToast&&showCenterToast("Orden de reseñas actualizado."):window.showCenterToast&&showCenterToast("No se pudo guardar el nuevo orden.","error")}catch{window.showCenterToast&&showCenterToast("Error de conexión al guardar el orden.","error")}}function B(){if(C==="general"){xe();return}if(C==="gallery"){Oe();return}if(C==="reviews"){se();return}const t=we(k);if(!t){_.innerHTML='<div class="live-editor-panel-empty">Selecciona un bloque de la izquierda para editarlo aquí, o "Información general" para nombre, slug, precio y SEO.</div>';return}const e=D[t.type]||D.default;if(_.innerHTML=`
            <div class="live-editor-panel-header">
                <span class="live-editor-panel-header-info">
                    <span class="live-editor-block-icon">
                    ...
                    <span>
                        <strong>${o(t.title||j[t.type]||t.type)}</strong>
        ...
        `,_.querySelector("#lePanelClose").addEventListener("click",()=>{k=null,L(),B()}),_.querySelector("#leTitle").addEventListener("input",r=>{t.title=r.target.value,c(),L(),d()}),$e.includes(t.type)){const r=t.config=t.config||{};r.title_style=r.title_style||{},P(_.querySelector("#leTitleStyle"),r.title_style,{tagChoices:["h2","h3"]})}Qe(_.querySelector("#leTypeFields"),t)}const $e=["benefits_grid","process_steps","content_tabs","gallery_carousel","faq"];function Qe(t,e){const r=e.config=e.config||{};switch(e.type){case"banner":V(t,r,"");break;case"dual_banner":t.innerHTML='<p class="hs-config-subtitle">Banner Izquierdo</p><div id="leDbLeft"></div><p class="hs-config-subtitle">Banner Derecho</p><div id="leDbRight"></div>',r.left=r.left||{image_url:"",link_url:"",alt:""},r.right=r.right||{image_url:"",link_url:"",alt:""},V(t.querySelector("#leDbLeft"),r.left,"Left"),V(t.querySelector("#leDbRight"),r.right,"Right");break;case"product_carousel":ke(t,r,"");break;case"product_carousel_banner":t.innerHTML='<p class="hs-config-subtitle">Banner</p><div id="lePcbBanner"></div><p class="hs-config-subtitle">Productos del carrusel</p><div id="lePcbCarousel"></div>',V(t.querySelector("#lePcbBanner"),{image_url:r.banner_image_url,link_url:r.banner_link_url,alt:r.banner_alt},"PcbBanner",(a,i)=>{a==="image_url"&&(r.banner_image_url=i),a==="link_url"&&(r.banner_link_url=i),a==="alt"&&(r.banner_alt=i)}),ke(t.querySelector("#lePcbCarousel"),r,"Pcb");break;case"category_grid":Ze(t,r);break;case"brand_carousel":t.innerHTML='<p class="hs-config-note">Este bloque muestra automáticamente todas las marcas activas. No requiere configuración adicional.</p>';break;case"html_block":et(t,r);break;case"faq":tt(t,r);break;case"rich_header":rt(t,r);break;case"content_tabs":oe(t,r);break;case"benefits_grid":ce(t,r);break;case"process_steps":de(t,r);break;case"gallery_carousel":at(t,r);break;case"rating_reviews":it(t,r);break;case"cta_final":nt(t,r);break;case"button":ie(t,r);break;case"table_block":T(t,r);break;default:t.innerHTML='<p class="hs-config-note">Tipo de bloque desconocido.</p>'}}function V(t,e,r,a){const i="leBanner"+r+"Image",l="leBanner"+r+"Link",n="leBanner"+r+"Alt";t.innerHTML=`
            ${u("URL de Imagen",`
        ...
        `;const p=g=>a?a("image_url",g):e.image_url=g,s=g=>a?a("link_url",g):e.link_url=g,h=g=>a?a("alt",g):e.alt=g,m=t.querySelector("#"+i);m.addEventListener("input",()=>{p(m.value),c(),d()}),t.querySelector("#"+l).addEventListener("input",g=>{s(g.target.value),c(),d()}),t.querySelector("#"+n).addEventListener("input",g=>{h(g.target.value),c(),d()}),t.querySelector(".img-picker-trigger-btn").addEventListener("click",()=>{typeof window.openImagePicker=="function"&&window.openImagePicker(i)})}function ke(t,e,r){const a="leSource"+r,i="leLimit"+r,l="leCategory"+r,n="leBrand"+r,p="leCollection"+r,s="leManualWrap"+r,h=Object.keys(pe).map(y=>`<option value="${y}" ${e.source===y?"selected":""}>${pe[y]}</option>`).join("");t.innerHTML=`
            <div class="live-editor-field-row">
                ${u("Origen de Productos",`<select class="users-manager-select" id="${a}">${h}</select>`)}
        ...
        `,t.querySelector("#"+a).addEventListener("change",y=>{e.source=y.target.value,c(),m(),d()}),t.querySelector("#"+i).addEventListener("input",y=>{e.limit=parseInt(y.target.value,10)||10,c(),d()});function m(){const y=t.querySelector("#leSourceFields"+r);e.source==="category"?(y.innerHTML=u("Categoría",`<select class="users-manager-select" id="${l}">
                ...
                </select>`),y.querySelector("#"+p).addEventListener("change",g=>{e.collection_id=g.target.value||null,c(),d()})):e.source==="manual"?(y.innerHTML=`<div class="live-editor-field"><label>Productos</label><div id="${s}"></div></div>`,Ye(y.querySelector("#"+s),e.product_ids||[],g=>{e.product_ids=g,c(),d()})):y.innerHTML=""}m()}function Ye(t,e,r){t.innerHTML=`
        ...
        `,t.querySelector("#leFaqDescription").addEventListener("input",r=>{e.description=r.target.value,c(),d()}),t.querySelector("#leFaqAdd").addEventListener("click",()=>{v.faqs=v.faqs||[],v.faqs.push({question:"",answer:""}),c(),le(t.querySelector("#leFaqRows"))}),le(t.querySelector("#leFaqRows")),t.querySelector("#leFaqSaveBtn").addEventListener("click",()=>Se({btnId:"leFaqSaveBtn",errorsBoxId:"leFaqErrors"}))}function rt(t,e){t.innerHTML=`
...
`))}</textarea>`)}
            ...
            ${u("Imágenes de fondo (galería del servicio)",`<select class="users-manager-select" id="leRhBgImages" multiple size="4">${U(e.background_image_ids,b.images)}</select>`)}
            <div class="show-user-divider" style="margin:10px 0;"></div>
        ...
        `,t.querySelector("#leRhBadges").addEventListener("input",r=>{e.badges=r.target.value.split("·").map(a=>a.trim()).filter(Boolean).slice(0,3),c(),d()}),t.querySelector("#leRhMetaLines").addEventListener("input",r=>{e.meta_lines=r.target.value.split(`
`).map(a=>a.trim()).filter(Boolean),c(),d()}),t.querySelector("#leRhWhatsapp").addEventListener("input",r=>{e.whatsapp_text=r.target.value,c(),d()}),t.querySelector("#leRhPriceLabel").addEventListener("input",r=>{e.price_label=r.target.value,c(),d()}),t.querySelector("#leRhBgImages").addEventListener("change",r=>{e.background_image_ids=Array.from(r.target.selectedOptions).map(a=>parseInt(a.value,10)),c(),d()}),e.title_style=e.title_style||{},e.subtitle_style=e.subtitle_style||{},P(t.querySelector("#leRhTitleStyle"),e.title_style,{}),P(t.querySelector("#leRhSubtitleStyle"),e.subtitle_style,{})}function oe(t,e){e.tabs=e.tabs||[];let r='<p class="hs-config-note">Cada pestaña se muestra como pestaña horizontal en público.</p><div id="leCtRows" class="hs-repeat-rows"></div><button type="button" class="button-secondary size-adjustment" id="leCtAdd" style="margin-top:10px;">+ Agregar pestaña</button>';t.innerHTML=r;const a=t.querySelector("#leCtRows");e.tabs.forEach((i,l)=>{const n=document.createElement("div");n.className="hs-repeat-row",n.innerHTML=`
...
`))}</textarea>
                <select class="users-manager-select le-image" style="margin-top:6px;">
                    ...
                    ${U(i.image_id?[i.image_id]:[],b.images)}
                </select>
...
`).map(s=>s.trim()).filter(Boolean),c(),d()}),n.querySelector(".le-image").addEventListener("change",p=>{i.image_id=p.target.value||null,c(),d()}),n.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.tabs.splice(l,1),c(),oe(t,e),d()}),i.style=i.style||{},P(n.querySelector(".le-tab-style"),i.style,{}),a.appendChild(n)}),t.querySelector("#leCtAdd").addEventListener("click",()=>{e.tabs.push({label:"",subtitle:"",body:"",bullets:[],image_id:null}),c(),oe(t,e),d()})}function ce(t,e){e.items=e.items||[],e.layout=e.layout==="vertical"?"vertical":"horizontal",t.innerHTML=`
        ...
        `,t.querySelector("#leBgLayout").addEventListener("change",a=>{e.layout=a.target.value,c(),d()});const r=t.querySelector("#leBgRows");e.items.forEach((a,i)=>{const l=document.createElement("div");l.className="hs-repeat-row",l.innerHTML=`
                ...
                <input type="text" class="users-manager-input le-figure" placeholder="Cifra (ej. -12%)" value="${o(a.figure)}">
                <input type="text" class="users-manager-input le-title" placeholder="Título" style="margin-top:6px;" value="${o(a.title)}">
                <textarea class="users-manager-input client-modal-textarea le-description" rows="2" placeholder="Descripción corta" style="margin-top:6px;">${o(a.description)}</textarea>
            `,l.querySelector(".le-figure").addEventListener("input",n=>{a.figure=n.target.value,c(),d()}),l.querySelector(".le-title").addEventListener("input",n=>{a.title=n.target.value,c(),L(),d()}),l.querySelector(".le-description").addEventListener("input",n=>{a.description=n.target.value,c(),d()}),l.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.items.splice(i,1),c(),ce(t,e),d()}),r.appendChild(l)}),t.querySelector("#leBgAdd").addEventListener("click",()=>{e.items.push({figure:"",title:"",description:""}),c(),ce(t,e),d()})}function de(t,e){e.steps=e.steps||[],t.innerHTML='<p class="hs-config-note">Pasos numerados del proceso.</p><div id="lePsRows" class="hs-repeat-rows"></div><button type="button" class="button-secondary size-adjustment" id="lePsAdd" style="margin-top:10px;">+ Agregar paso</button>';const r=t.querySelector("#lePsRows");e.steps.forEach((a,i)=>{const l=document.createElement("div");l.className="hs-repeat-row",l.innerHTML=`
                <div class="hs-repeat-row-head"><span class="hs-repeat-row-num">${i+1}</span><button type="button" class="hs-faq-btn hs-repeat-remove" title="Eliminar">&times;</button></div>
                <input type="text" class="users-manager-input le-title" placeholder="Título del paso" value="${o(a.title)}">
                <textarea class="users-manager-input client-modal-textarea le-description" rows="2" placeholder="Descripción" style="margin-top:6px;">${o(a.description)}</textarea>
                <input type="text" class="users-manager-input le-duration" placeholder="Duración (ej. 1 h)" style="margin-top:6px;" value="${o(a.duration)}">
            `,l.querySelector(".le-title").addEventListener("input",n=>{a.title=n.target.value,c(),L(),d()}),l.querySelector(".le-description").addEventListener("input",n=>{a.description=n.target.value,c(),d()}),l.querySelector(".le-duration").addEventListener("input",n=>{a.duration=n.target.value,c(),d()}),l.querySelector(".hs-repeat-remove").addEventListener("click",()=>{e.steps.splice(i,1),c(),de(t,e),d()}),r.appendChild(l)}),t.querySelector("#lePsAdd").addEventListener("click",()=>{e.steps.push({title:"",description:"",duration:""}),c(),de(t,e),d()})}function at(t,e){t.innerHTML=u("Imágenes a mostrar (vacío = toda la galería)",`
            <select class="users-manager-select" id="leGcImages" multiple size="6">${U(e.image_ids,b.images)}</select>
        ...
        `),t.querySelector("#leGcImages").addEventListener("change",r=>{e.image_ids=Array.from(r.target.selectedOptions).map(a=>parseInt(a.value,10)),c(),d()})}function it(t,e){t.innerHTML=`
        ...
        `,t.querySelector("#leRrDescription").addEventListener("input",r=>{e.description=r.target.value,c(),d()}),t.querySelector("#leRrPerPage").addEventListener("input",r=>{e.reviews_per_page=parseInt(r.target.value,10)||3,c(),d()})}function nt(t,e){t.innerHTML=`
            ...
            ${u("Imagen de fondo (opcional)",`<select class="users-manager-select" id="leCtaBg"><option value="">Sin imagen</option>${U(e.background_image_id?[e.background_image_id]:[],b.images)}</select>`)}
            <div class="show-user-divider" style="margin:10px 0;"></div>
        ...
        `,t.querySelector("#leCtaHeadline").addEventListener("input",r=>{e.headline=r.target.value,c(),d()}),t.querySelector("#leCtaSubtext").addEventListener("input",r=>{e.subtext=r.target.value,c(),d()}),t.querySelector("#leCtaWhatsapp").addEventListener("input",r=>{e.whatsapp_text=r.target.value,c(),d()}),t.querySelector("#leCtaBg").addEventListener("change",r=>{e.background_image_id=r.target.value||null,c(),d()}),e.headline_style=e.headline_style||{},e.subtext_style=e.subtext_style||{},P(t.querySelector("#leCtaHeadlineStyle"),e.headline_style,{tagChoices:["h2","h3"]}),P(t.querySelector("#leCtaSubtextStyle"),e.subtext_style,{}),e.secondary_button=e.secondary_button||{text:"",url:"",style:"outline",color:"#ff6213"},ae(t.querySelector("#leCtaSecondaryBtn"),e.secondary_button,{alignField:!1})}let Ce=null;function d(){clearTimeout(Ce),Ce=setTimeout(qe,400)}async function qe(){try{const e=await(await fetch(b.previewUrl,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":$,Accept:"application/json"},body:JSON.stringify({sections:S.filter(r=>r.is_active).map((r,a)=>({...r,sort_order:a}))})})).json();F.srcdoc=e.html??""}catch(t){console.error("Error generando el preview:",t)}}F.addEventListener("load",()=>{try{const t=F.contentDocument;if(!t)return;const e=we(k);if(e&&e.id){const r=t.createElement("style");r.textContent=`[data-section-id="${e.id}"] { outline: 3px solid #ff6213; outline-offset: 2px; cursor: pointer; }`,t.head.appendChild(r)}t.body.addEventListener("click",r=>{const a=r.target.closest("[data-section-id]");if(!a)return;const i=a.getAttribute("data-section-id"),l=S.find(n=>String(n.id)===String(i));l&&(r.preventDefault(),ne(l._uid))},!0)}catch{}});const Te=document.getElementById("leViewportCaption");function lt(){Te&&(Te.textContent=J==="mobile"?"Móvil · 375px":"Escritorio · 1440px")}me.addEventListener("click",t=>{const e=t.target.closest("button[data-viewport]");e&&(J=e.dataset.viewport,me.querySelectorAll("button").forEach(r=>r.classList.toggle("is-active",r===e)),F.classList.toggle("is-mobile",J==="mobile"),lt())}),G.addEventListener("click",async()=>{G.disabled=!0;const t=G.textContent;G.textContent="Guardando...",N.textContent="Guardando…",N.className="live-editor-status is-saving";try{if(!(await fetch(b.saveUrl,{method:"PUT",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":$,Accept:"application/json"},body:JSON.stringify({sections:S.map((r,a)=>({...r,sort_order:a}))})})).ok)throw new Error("save request failed");window.location.reload()}catch(e){console.error("Error guardando la página:",e),alert("No se pudieron guardar los cambios. Intenta de nuevo."),G.disabled=!1,G.textContent=t,c()}}),S.length?(L(),B()):fe(),qe()})();
